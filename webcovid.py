...
st.set_page_config(page_title="Kelompok9", page_icon=im, layout="wide")
with open('style.css') as f:
    st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)
    st.header('Covid-19 Dashboard')
    st.sidebar.markdown("<h2 style='text-align: center; font-weight: bold; color: white;'>KELOMPOK 9</h2>", unsafe_allow_html=True)
    st.sidebar.markdown("""
        *Yudha Mansoba\n
        *Ida Ayu Oka Dewi Cahyani\n
        *Riana Pramesti Putri\n
        *Yudha Artha Nugrahan\n
        *Alvin Surya Anandhita\n
...
def get_data_from_csv():
    df = pd.read_csv("C:/Users/Yudha Mansoba/Documents/WEB DATASET COVID19/data/covid19.csv")
    df_province = pd.read_csv("C:/Users/Yudha Mansoba/Documents/WEB DATASET COVID19/data/daily_case_province_covid19.csv")
    df_province_death = pd.read_csv("C:/Users/Yudha Mansoba/Documents/WEB DATASET COVID19/data/daily_death_province_covid19.csv")
    df_province_recovered = pd.read_csv("C:/Users/Yudha Mansoba/Documents/WEB DATASET COVID19/data/daily_recovered_province_covid19.csv")
    df_vaccinated = pd.read_csv("C:/Users/Yudha Mansoba/Documents/WEB DATASET COVID19/data/vaccine_covid19.csv")
